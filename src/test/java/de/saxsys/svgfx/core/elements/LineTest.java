...
public final class LineTest {
    ...
    @Test public void parse() {
        ...
        URL url = getClass().getClassLoader().getResource("de/saxsys/svgfx/core/elements/line.svg");
        ...
        Assert.assertThat(parser.getResult().getChildren().get(0), new IsInstanceOf(Line.class));
        Assert.assertThat(parser.getResult().getChildren().get(1), new IsInstanceOf(Line.class));
    }
}
