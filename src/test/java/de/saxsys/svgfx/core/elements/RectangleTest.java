...
public final class RectangleTest {
    ...
    @Test public void parse() {
        ...
        URL url = getClass().getClassLoader().getResource("de/saxsys/svgfx/core/elements/rectangle.svg");
        ...
        Assert.assertThat(parser.getResult().getChildren().get(0), new IsInstanceOf(javafx.scene.shape.Rectangle.class));
    }
}
