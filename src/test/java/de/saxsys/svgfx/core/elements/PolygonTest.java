...
public final class PolygonTest {
    ...
    public void parse() {
        ...
        URL url = getClass().getClassLoader().getResource("de/saxsys/svgfx/core/elements/polygon.svg");
        ...
        Assert.assertThat(parser.getResult().getChildren().get(0), new IsInstanceOf(javafx.scene.shape.Polygon.class));
    }
}
