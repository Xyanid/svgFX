...
public class VerticalLineCommandTest {
    ...
    public void dependingOnTheDataTheBoundingBoxWillBeCorrectlyCalculatedIfTheCommandIsRelative() throws Exception {
        ...
        assertEquals(10.0d, boundingBox1.get().getHeight(), 0.01d);


        final Optional<Rectangle> boundingBox2 = new VerticalLineCommand(false, -10.0d).getBoundingBox(new Point2D(20, 10));

        assertEquals(20.0d, boundingBox2.get().getX(), 0.01d);
        assertEquals(0.0d, boundingBox2.get().getY(), 0.01d);
        assertEquals(0.0d, boundingBox2.get().getWidth(), 0.01d);
        assertEquals(10.0d, boundingBox2.get().getHeight(), 0.01d);

        final Optional<Rectangle> boundingBox3 = new VerticalLineCommand(false, 10.0d).getBoundingBox(new Point2D(30, -10));

        assertEquals(30.0d, boundingBox3.get().getX(), 0.01d);
        assertEquals(-10.0d, boundingBox3.get().getY(), 0.01d);
        assertEquals(0.0d, boundingBox3.get().getWidth(), 0.01d);
        assertEquals(10.0d, boundingBox3.get().getHeight(), 0.01d);

        final Optional<Rectangle> boundingBox4 = new VerticalLineCommand(false, -10.0d).getBoundingBox(new Point2D(40, -10));

        assertEquals(40.0d, boundingBox4.get().getX(), 0.01d);
        assertEquals(-20.0d, boundingBox4.get().getY(), 0.01d);
        assertEquals(0.0d, boundingBox4.get().getWidth(), 0.01d);
        assertEquals(10.0d, boundingBox4.get().getHeight(), 0.01d);
    }
    ...
    public void dependingOnTheDataTheBoundingBoxWillBeCorrectlyCalculatedIfTheCommandIsAbsolute() throws Exception {
        ...
        assertEquals(20.0d, boundingBox2.get().getX(), 0.01d);
        assertEquals(-10.0d, boundingBox2.get().getY(), 0.01d);
        assertEquals(0.0d, boundingBox2.get().getWidth(), 0.01d);
        ...
        assertEquals(40.0d, boundingBox4.get().getX(), 0.01d);
        assertEquals(-10.0d, boundingBox4.get().getY(), 0.01d);
        assertEquals(0.0d, boundingBox4.get().getWidth(), 0.01d);
