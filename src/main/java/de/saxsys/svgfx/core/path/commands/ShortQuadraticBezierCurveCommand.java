 ...
 */
public final class ShortQuadraticBezierCurveCommand extends BezierCurveCommand {

    // region Constants

    /**
     * The absolute name of a short quadratic bezier curve command.
     */
    public static final char ABSOLUTE_NAME = 'T';

    /**
     * The relative name of a short quadratic bezier curve command.
     */
     ...
     */
    ShortQuadraticBezierCurveCommand(final String data) throws PathException {
        super(data);
    }
